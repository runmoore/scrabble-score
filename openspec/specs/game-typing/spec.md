# Capability: Game Typing

## Purpose

Allow users to categorize games by type (e.g., "Scrabble", "Sushi Go", "Molkky") so that games are labeled and identifiable throughout the application.
